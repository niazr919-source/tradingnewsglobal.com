...
takeaways:
  - "Every order type trades certainty of execution against certainty of price; you cannot have both."
  - "A stop-loss becomes a market order when triggered, so it guarantees an attempt to exit but not the exit price. In a gap it can fill far beyond your level."
  - "A stop-limit protects against a bad fill but introduces the opposite risk: if price gaps through your limit, the order does not fill and you keep the position."
faq:
