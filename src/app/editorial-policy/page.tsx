...
export const metadata: Metadata = {
  ...
  description: `How ${siteConfig.name} decides what to publish, sources and checks its work, handles corrections, and keeps advertising separate from editorial.`,
...
export default function EditorialPolicyPage() {
  return (
    <PageShell
      title="Editorial policy"
      intro="How we decide what to publish, how we check it, how we correct it when we get it wrong, and where the line sits between our coverage and our advertising."
      updated={UPDATED}
    >
      <h2>Our purpose</h2>
      <p>
        {siteConfig.name} exists to explain how financial markets work to people who are not
        professionals. The test we apply to every article is whether a reader finishes it
        understanding a mechanism they did not understand before. We are not trying to tell anyone
        what to buy.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>No paid or sponsored articles.</strong> Nobody can buy a place in our coverage. If
          we ever publish sponsored material, it will be labelled unmistakably and will not appear in
          article feeds.
        </li>
        <li>
        ...
        <li>
          <strong>No token or product promotion.</strong> We do not accept payment to cover a coin,
          project or platform, and we do not publish press releases as news.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          Where an article relies on external facts, those sources are listed at the foot of the
          article so you can check them yourself.
        </li>
        <li>Figures are checked against the original release, not against another article quoting it.</li>
        <li>
      ...
      <h2>Corrections</h2>
      <p>We correct errors promptly and visibly rather than quietly editing them away.</p>
      <ul>
        <li>
          <strong>Minor fixes</strong> — typos, broken links, formatting — are made without a note.
        </li>
        <li>
          <strong>Factual corrections</strong> are made in the text and noted at the foot of the
          article, stating what was wrong and when it was fixed.
        </li>
        <li>
          <strong>Substantial corrections</strong> that change an article&apos;s conclusion are noted
          at the top of the article as well.
        </li>
        <li>
      ...
      <p>
        Explainers are reviewed periodically and revised when rules, market structure or figures
        change. We do not silently rewrite an old article to look like new reporting, and we do not
        backdate or forward-date articles to game search rankings.
      </p>

      <h2>Separation of advertising and editorial</h2>
      <p>
        Advertising on this site is served programmatically by third-party networks. We have no
      ...
      <p>
        Anyone contributing to {siteConfig.name} must disclose a material holding in an asset they
        write about, and may not trade around the publication of an article they worked on. Where such
        a position exists, the article says so.
      </p>
      ...
      <p>
        ...
        article, the passage and what you think is wrong. We will investigate and reply, and if we got
        it wrong we will correct it under the process above.
      </p>
    </PageShell>
  );
}
