...
takeaways:
  - "Short selling means borrowing shares, selling them, and buying them back later to return them, profiting if the price fell in between."
  - "Losses are theoretically unlimited because a price can rise without limit, and the position grows larger as it moves against you."
  - "Costs accrue daily: a borrow fee that can reach double-digit annual percentages on scarce shares, plus reimbursing any dividends to the lender."
faq:
