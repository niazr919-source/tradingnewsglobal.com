...
takeaways:
  - "Prospect theory found losses are felt roughly twice as intensely as equivalent gains, which drives the tendency to hold losers and sell winners."
  - "The disposition effect produces a portfolio of small gains and large losses, the exact reverse of what recovery arithmetic requires."
  - "Structural fixes outperform willpower: stops placed at entry, fixed position limits, and a hard daily loss limit decided in advance."
faq:
