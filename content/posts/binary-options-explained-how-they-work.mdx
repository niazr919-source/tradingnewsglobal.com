...
takeaways:
  - "A binary option pays a fixed amount if you are right and takes the entire stake if you are wrong, which makes the expected return negative by construction."
  - "At a typical 80% payout you must be right about 55.6% of the time simply to break even, on timeframes where price movement is mostly noise."
  - "The UK, EU and Australia each banned or restricted their sale to retail investors after reviewing firms' own client outcome data."
faq:
