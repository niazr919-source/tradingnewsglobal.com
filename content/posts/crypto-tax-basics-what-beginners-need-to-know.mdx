...
takeaways:
  - "Most jurisdictions treat cryptocurrency as property, so disposing of it realises a gain or loss even when no conventional currency is involved."
  - "Swapping one token for another and spending crypto on goods are usually taxable events, which surprises people who never withdrew to a bank account."
  - "Staking and mining rewards are commonly taxed as income at the moment received, creating a liability fixed at that day's price even if the asset later falls."
faq:
