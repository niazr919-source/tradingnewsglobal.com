...
seoTitle: "Why Most Retail Traders Lose Money: The Data"
seoDescription: "Brokers must publish how many clients lose money. It is 70-80%. Here is what drives that number, and the five reasons behind it."
...
takeaways:
  - "Brokers regulated in the EU and UK must publish the share of retail accounts that lose money; the figure sits consistently between 70% and 80%."
  - "The main causes are structural rather than psychological: trading costs multiplied by frequency, leverage that shortens survival time, and the asymmetry that a 50% loss requires a 100% gain to recover."
  - "Studies across US, Taiwanese and Brazilian markets independently found that higher trading frequency correlates with worse returns."
faq:
