...
takeaways:
  - "You buy at the ask and sell at the bid, so every position begins at a loss equal to the spread before the market has moved."
  - "A 0.05% round-trip spread traded twenty times a month costs roughly 12% of turnover annually, which usually exceeds any small edge."
  - "Commission-free brokers recover the cost through wider spreads or payment for order flow, moving it from a visible line item into the execution price."
faq:
