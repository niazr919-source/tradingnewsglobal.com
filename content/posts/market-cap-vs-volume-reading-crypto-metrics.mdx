...
takeaways:
  - "Market capitalisation is circulating supply times the last traded price. It is not money invested and not what could be realised by selling."
  - "In thin markets a small amount of buying moves the price sharply, and that new price is then multiplied across the entire supply."
  - "Order book depth, not volume, answers the only question that matters: how much could you actually sell before moving the price."
faq:
