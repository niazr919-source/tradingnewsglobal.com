...
takeaways:
  - "A CBDC is a direct claim on the central bank, unlike a bank deposit which is a claim on a commercial bank that can fail."
  - "It is not a cryptocurrency: it is issued by a central authority with full control over supply, which is the opposite of what defines Bitcoin."
  - "Whether a CBDC is privacy-preserving or surveillance infrastructure is a design choice, not a technical inevitability."
faq:
