...
seoTitle: "The US Dollar Index (DXY) Explained"
seoDescription: "What the DXY measures, why it is really a euro trade, and when to use the Fed trade-weighted index instead."
category: "forex"
...
takeaways:
  - "The DXY tracks the dollar against six currencies using weightings set in 1973, with the euro alone accounting for close to 58%."
  - "It contains no Chinese yuan, Mexican peso or any emerging market currency, despite those being major US trading partners."
  - "For economic analysis the Federal Reserve's trade-weighted indices are more accurate; the DXY persists because it is liquid and widely traded."
faq:
