...
seoTitle: "Ethereum Staking: Where the Yield Comes From"
seoDescription: "The three sources of ETH staking yield, the four risks attached, and why liquid staking tokens are not the same thing as ETH."
category: "crypto"
...
takeaways:
  - "Staking yield comes from three sources: new issuance, which is dilution paid by non-stakers, plus transaction priority fees and block-ordering revenue, which are real economic activity."
  - "The yield is not fixed. It falls as more ETH is staked and rises when network activity increases."
  - "A liquid staking token is a claim on staked ETH, not ETH itself, and has traded below the value of the underlying during periods of stress."
faq:
