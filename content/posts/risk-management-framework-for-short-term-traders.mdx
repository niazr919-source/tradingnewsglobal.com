...
seoTitle: "A Trading Risk Management Framework That Works"
seoDescription: "Risk per trade, position sizing, correlation limits and drawdown rules — the six layers that keep an account alive through a bad run."
...
takeaways:
  - "Risking 1% of equity per trade leaves about 82% of an account intact after twenty consecutive losses; risking 5% leaves about 36%."
  - "Position size should be derived from your risk limit and stop distance, never chosen first."
  - "Correlated positions are one position: long EUR/USD, long GBP/USD and short USD/JPY is a single short-dollar bet expressed three ways."
faq:
