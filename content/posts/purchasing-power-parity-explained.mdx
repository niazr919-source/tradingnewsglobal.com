...
takeaways:
  - "Purchasing power parity holds that identical goods should cost the same across countries once converted at the exchange rate."
  - "It fails over the horizons anyone trades on because most spending is on non-tradable goods and services, which no arbitrage connects across borders."
  - "PPP is genuinely useful for comparing living standards between countries and poor at predicting exchange rate movement."
faq:
