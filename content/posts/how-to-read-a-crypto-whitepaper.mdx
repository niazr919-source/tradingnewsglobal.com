...
takeaways:
  - "A whitepaper is a fundraising document reviewed by nobody, with no legal consequence for being wrong, borrowing the visual authority of academic publishing."
  - "The single most useful question is whether the token is necessary. If the product could run without it, the token exists to be sold rather than used."
  - "The token distribution and unlock schedule predict your outcome better than the technology section does."
faq:
