...
takeaways:
  - "QE is an asset swap between a central bank and the financial system, not money handed to households, which is why calling it money printing leads to wrong predictions."
  - "Over a decade of large QE programmes after 2008 coincided with inflation persistently below target, contradicting the simplest money-printing account."
  - "The evidence that QE lowers bond yields and raises asset prices is strong; the evidence that it raises consumer prices is contested and conditional."
faq:
