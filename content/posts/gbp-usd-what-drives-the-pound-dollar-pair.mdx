...
seoTitle: "What Drives GBP/USD? Why Cable Moves So Much"
seoDescription: "Sterling is more volatile than the euro for structural reasons: a smaller economy, a current account deficit and a finance-heavy make-up."
category: "forex"
...
takeaways:
  - "Sterling is more volatile than the euro because the UK economy is smaller, runs a persistent current account deficit and is unusually weighted toward financial services."
  - "The Bank of England publishes its nine-member vote split with each decision, making internal disagreement visible in a way most central banks do not."
  - "Checking EUR/GBP alongside GBP/USD separates a sterling move from a dollar move."
faq:
