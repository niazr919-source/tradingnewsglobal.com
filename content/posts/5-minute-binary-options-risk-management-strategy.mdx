...
seoTitle: "Can Risk Management Fix Negative Expectancy?"
seoDescription: "Risk management controls how fast you lose, not whether you lose. Here is the expectancy arithmetic behind short-expiry trading."
...
takeaways:
  - "Risk management controls how much you lose per event and how long you survive; it cannot change the sign of a strategy's expected return."
  - "Expectancy is win rate times average win, minus loss rate times average loss, minus costs. If that number is negative, more trading produces more loss."
  - "Establish that expectancy is positive from at least 100 of your own logged trades before applying any risk framework to it."
faq:
