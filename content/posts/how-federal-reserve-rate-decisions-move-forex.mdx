...
seoTitle: "How Fed Rate Decisions Move Currency Markets"
seoDescription: "Why the dollar sometimes falls after a rate rise, what the dot plot signals, and how FOMC expectations reach an exchange rate."
category: "forex"
...
takeaways:
  - "Currency markets price expectations in advance, so a fully anticipated rate decision usually moves little; the projected path is what moves prices."
  - "The dot plot in the Fed's quarterly projections shows where each committee member expects rates to be, and shifts in the median move markets."
  - "Hawkish and dovish are relative to what was already priced, which is why a rate cut smaller than expected can strengthen a currency."
faq:
