...
seoTitle: "What Moves the Price of Gold? Real Yields"
seoDescription: "Gold pays no income, so real yields set the cost of holding it. That one relationship explains most of gold's behaviour, hedging included."
category: "markets"
...
takeaways:
  - "Gold pays no income, so its main cost is the interest given up by not holding a bond. That cost is the real yield, and the inverse relationship between the two explains most of gold's behaviour."
  - "Gold has broadly preserved purchasing power over centuries but has delivered real losses over decade-long periods, making the inflation hedge description unreliable."
  - "Central bank buying has become a structural source of demand that is insensitive to price, because it is driven by reserve policy rather than by investment returns."
faq:
