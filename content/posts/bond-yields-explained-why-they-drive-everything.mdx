...
takeaways:
  - "A bond's cash flows are fixed, so when market interest rates rise its price must fall until the return matches what is available elsewhere. Price and yield are two descriptions of one thing."
  - "The real yield is the nominal yield minus expected inflation, and it is the number that drives gold, long-duration equities and currency differentials."
  - "An inverted yield curve, where short-term yields exceed long-term ones, has preceded most US recessions since the 1960s but with lags ranging from months to over two years."
faq:
