...
takeaways:
  - "The most expensive beginner mistake is position sizing that cannot survive a normal losing run, not poor analysis."
  - "None of the top five costliest mistakes concern market analysis; all concern size, frequency and the response to losing."
  - "Trading frequency correlates negatively with returns because every trade pays a spread regardless of whether the strategy has an edge."
faq:
