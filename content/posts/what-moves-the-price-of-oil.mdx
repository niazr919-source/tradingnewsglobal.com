...
seoTitle: "What Moves Oil Prices: Supply, Demand and Risk"
seoDescription: "OPEC policy, US shale economics, inventories and the geopolitical risk premium — how crude oil is actually priced."
category: "markets"
...
takeaways:
  - "Oil demand is price-inelastic in the short run, so small supply changes produce large price moves."
  - "US shale acts as a soft ceiling on rallies because wells can be drilled in months, unlike conventional fields that take years."
  - "A futures curve in contango signals oversupply and rewards storage; backwardation signals physical scarcity and rewards selling now."
faq:
