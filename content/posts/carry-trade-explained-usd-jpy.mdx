...
seoTitle: "The Carry Trade Explained: USD/JPY and the Yen"
seoDescription: "Why the carry trade profits slowly and loses fast, why the yen is the classic funding currency, and what triggers a violent unwind."
category: "forex"
...
takeaways:
  - "A carry trade borrows in a low interest rate currency and invests in a higher one, earning the differential as long as the exchange rate does not move against the position."
  - "Unwinds are violent because closing the trade means buying back the funding currency, which pushes the rate further against everyone still in it."
  - "The yen strengthens during market stress not because Japan became attractive, but because carry positions funded in yen are being closed."
faq:
