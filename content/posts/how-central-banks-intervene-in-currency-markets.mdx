...
seoTitle: "How Central Banks Intervene in Currency Markets"
seoDescription: "From verbal warnings to spending reserves — the escalation ladder of FX intervention, and the research on when it actually works."
category: "forex"
...
takeaways:
  - "A central bank can weaken its own currency indefinitely because it can create unlimited amounts of it, but can only strengthen it while foreign reserves last."
  - "Reserve levels are published, so markets can calculate how long a defence can be sustained, which is what invites speculative attack."
  - "Intervention tends to work when it aligns with interest rate fundamentals and fails when it fights them."
faq:
