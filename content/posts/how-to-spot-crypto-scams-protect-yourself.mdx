...
seoTitle: "How to Spot Crypto Scams: 7 Patterns to Know"
seoDescription: "Nearly every crypto scam fits one of seven templates. Here are the tells for each, and what to do if you have already been caught."
category: "crypto"
...
takeaways:
  - "Almost every crypto scam fits one of seven templates, and nearly all fail one question: how, specifically, could I lose money here?"
  - "A guaranteed or fixed return is the defining feature of fraud, because removing risk costs money and nobody does it for free."
  - "Any company promising to recover stolen crypto for an upfront fee is running a second scam on the same victim."
faq:
